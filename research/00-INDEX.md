...
| 09 | [`09-support-resistance.md`](./09-support-resistance.md) | ~310 | Claude Opus 4.8 | S/R methods (swing fractals, classic + Fib pivots, Fib retracement) with formulas + confluence/clustering algo, **plus a concrete design spec** for a ranked S/R map (`levels[]`) on every suggested trade. |
